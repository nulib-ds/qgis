...
> [QGIS Plugins](https://plugins.qgis.org/) are similiar to a library and add additional functionality to the QGIS application. These plugins can be installed directly from the QGIS Plugin Manager within the QGIS application. <br>
> 
...
> If you're not familiar with Python, this is a great way for you to try it out. We'll only be copying and pasting the code below, but remember Python can be a powerful language you can use to automate geoprocessess. 
