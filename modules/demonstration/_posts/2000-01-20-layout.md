...
**You can also bring in basemaps by using the QuickOSM PlugIn. [QGIS Plugins](https://plugins.qgis.org/) are simialr to a library and add additional functionality to the QGIS application. These plugins can be installed directly from the QGIS Plugin Manager within the QGIS application.** 
