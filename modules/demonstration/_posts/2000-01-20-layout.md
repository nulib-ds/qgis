...
> 
> Select the **Search QMS button** and type in the search bar **"esri"** and select the **ESRI Gray (light)**.

<br> 

> #### More comfortable: Python <br>
> QGIS supports the programming language Python. We'll only be copying and pasting the code below in the console, but remember Python is a powerful language you can use to automate geoprocessess. Check out a tutorial using the PyQGIS [here](https://www.qgistutorials.com/en/docs/3/getting_started_with_pyqgis.html).
