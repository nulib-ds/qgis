...
> If you're not familiar with Python, this is a great way for you to try it out. We'll only be copying and pasting the code below, but remember Python can be a powerful tool you can use to automate geoprocessess. 
