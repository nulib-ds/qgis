...
**There are many ways to add in basemaps, or scalable, referenced image layers. Below are two ways you can add them.**

<br>

> #### Less comfortable: QuickMapServices Plug-in  <br>
> [QGIS Plugins](https://plugins.qgis.org/) add additional functionality to the QGIS application. These plugins can be installed directly from the QGIS Plugin Manager within the QGIS application. <br>
> 
> Select the **Search QMS button** and type in the search bar **"esri"**. Then select the **ESRI Gray (light)** feature layer. 

<br> 

> #### More comfortable: Python <br>
> QGIS supports the programming language Python. We'll only be copying and pasting the code below in the terminal, but remember Python is a powerful language you can use to automate geoprocessess. Check out a tutorial using the PyQGIS [here](https://www.qgistutorials.com/en/docs/3/getting_started_with_pyqgis.html).
